...
class Subscriber extends Model
{
    ...
    const SUBSCRIPTION_TYPE_ADDED = 'added';
    ...
    public function verify($verifier)
    {
        ...
        $log = $this->emailVerifications()->firstOrNew();
        $log->result = $result;
        $log->details = $details;
    ...
    public function updateTags($arr)
    {
        ...
        //
        $this->tags = json_encode($arr, JSON_UNESCAPED_UNICODE);
        $this->save();
    }
    ...
    public function scopeUnsubscribed()
    {
        return self::where('status', '=', self::STATUS_UNSUBSCRIBED);
    }
